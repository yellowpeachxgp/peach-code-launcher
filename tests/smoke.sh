...
assert_contains install.sh 'PEACH_CODE_VERSION="0.5.0"'
...
assert_contains install.ps1 '$PeachCodeVersion = "0.5.0"'
...
assert_contains /tmp/peach-code-smoke-install.log 'Peach Code 安装器 0.5.0'
